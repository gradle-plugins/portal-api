...
//    }
    ...
    private static final Pattern PLUGIN_ID_AND_VERSION_CODE_PATTERN = Pattern.compile("id \"(?<pluginId>[a-zA-Z0-9\\-.]+)\" version \"(?<pluginVersion>[a-zA-Z0-9\\-.]+)\"");
    private static final Pattern PLUGIN_NOTATION_CODE_PATTERN = Pattern.compile("classpath \"(?<groupId>[a-zA-Z0-9\\-.]+):(?<artifactId>[a-zA-Z\\-]+):(?<version>[a-zA-Z0-9\\-.]+)\"");
